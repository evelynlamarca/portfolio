...
| `<meta>`          | Fornece metadados (charset, descrição, autor, etc.).        | `charset`, `name`, `content`, `viewport`. | `<meta name="description" content="Portfólio de Evelyn Lamarca">` |
| `<title>`         | Define o título da página exibido no navegador.             | —                                         | `<title>Portfólio de Evelyn</title>`                         |
...
| `<footer>`  | Rodapé da página.                                     | —                    | `<footer>Feito com ❤️ por Evelyn</footer>`                 |
...
| `<meta name="author">`      | Define o autor da página.                                | `content="Evelyn Lamarca"`.                        | `<meta name="author" content="Evelyn Lamarca">`              |
